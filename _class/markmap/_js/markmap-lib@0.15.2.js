/*! markmap-lib v0.15.2 | MIT License */
...
const defaultProviders = {
  jsdelivr: path => `/_class/markmap/_katex/${path}`
};
class UrlBuilder {
  constructor() {
...
const name$3 = 'katex';
const preloadScripts$1 = [`katex.min.js`].map(path => buildJSItem(path));
const webfontloader = buildJSItem(`webfontloader.js`);
webfontloader.data.defer = true;
const styles$1 = [`katex.min.css`].map(path => buildCSSItem(path));
const config$1 = {
  versions: {
    katex: "0.16.8" ,
